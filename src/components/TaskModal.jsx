...
export default function TaskModal({
  ...
  return (
    <div>
      ...
      >
        <div className="m-3 mt-0 flex min-h-[calc(100%-3.5rem)] items-center opacity-0 transition-all ease-out hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:mx-auto sm:w-full sm:max-w-5xl">
          <div className="flex flex-col rounded-lg border bg-white px-4 py-2 shadow-sm">
            ...
            <div className="flex items-center justify-end gap-x-2 py-3 px-4 ">
              <button
                type="button"
                className="hs-dropdown-toggle inline-flex items-center justify-center gap-2 rounded-md border bg-white py-2 px-4 align-middle text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white  "
                data-hs-overlay="#hs-vertically-centered-modal"
              >
                Close
              </button>
