                ...
                >
                    ...
                    >
                        <div className="mt-5 flex flex-col gap-y-4 gap-x-0 sm:mt-0 sm:flex-row sm:items-center sm:gap-y-0 sm:gap-x-7 sm:pl-7">
                            <div className="flex flex-col justify-center sm:flex-row"></div>
                            <div className="flex items-center justify-center gap-x-2 sm:ml-auto">
                                ...
                                <Link href="/api/auth/login">
                                    <button className="inline-flex items-center justify-center gap-2 rounded border-[1px] border-jet-100 bg-jet-800 py-2 px-4 text-sm text-white transition-all hover:border-jet-400">
                                        Sign up
                                    </button>
                                </Link>
                            </div>
