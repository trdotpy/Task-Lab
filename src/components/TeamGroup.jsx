...
export default function TeamGroup() {
  return (
    <div class="flex items-center">
      <img
        class="-mx-1.3 h-6 w-6 rounded-full object-cover ring ring-1 ring-blue-400"
      ...
      />
      <img
        class="-mx-1.3 h-6 w-6 rounded-full object-cover ring ring-1 ring-violet-400"
      ...
      />
      <img
        class="-mx-1.3 h-6 w-6 rounded-full object-cover ring ring-1 ring-purple-400"
