    ...
    <div className="flex h-screen items-center justify-center">
      <div className="m-auto mx-auto w-full max-w-sm rounded-lg bg-white p-6 shadow-md">
        ...
        <form className="mt-6">
          ...
          <div className="mt-6">
            <button className="w-full transform rounded-lg bg-violet-400 px-6 py-2.5 text-sm font-medium capitalize tracking-wide text-white transition-colors duration-300 hover:bg-violet-600 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
              Sign In
            </button>
          </div>
        </form>
