                  ...
                  {(formik) => (
                    <form class="mt-4" onSubmit={formik.handleSubmit}>
                      <Field
                        ...
                        type="text"
                        placeholder="Title"
                        class="block w-full rounded-md border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
                      ...
                      <Field
                        ...
                        class="mt-3 block h-28 w-full rounded-md border border-gray-200 bg-white px-4 py-3 text-sm text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
